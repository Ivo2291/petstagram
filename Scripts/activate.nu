...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\SoftUni Education\PycharmProjects\Python_web_basics\petstagram'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\SoftUni Education\PycharmProjects\Python_web_basics\petstagram\Scripts\deactivate.nu'
